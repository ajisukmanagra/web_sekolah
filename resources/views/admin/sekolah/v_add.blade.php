    ...
    <div class="col-md-12">
                  ...
                  <div class="col-sm-6">
                       ...
                       <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" rows="7" class="form-control" placeholder="deskripsi"></textarea>
                                 <div class="text-danger">
                                    @error('deskripsi')
                                        {{ $message }}
                                    @enderror
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-info"><i class="fa fa-save"></i>Simpan</button>
             <a href="/sekolah" class="btn btn-warning float-right"><i class="fa fa-arrow-left" aria-hidden="true"></i>cencel</a>
        </div>
        </form>
        </div>
        </div>
