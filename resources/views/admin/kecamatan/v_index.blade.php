            ...
            <div class="card card-outline card-primary">
              <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="/kecamatan/add" type="button" class="btn btn-dark btn-sm btn-flat"><i class="fa fa-plus"></i> Add</a>
                </div>
                <!-- /.card-tools -->
              </div>
              <!-- /.card-header -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Kecamatan</th>
                            <th class="text-center">Warna Zona</th>
                            <th class="text-center"> No koordinat</th>
